...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="images/favicon/food.png" sizes="32x32">
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="images/favicon/food.png">
  <!-- For iPhone -->
  <meta name="msapplication-TileColor" content="#808080">
  <meta name="msapplication-TileImage" content="images/favicon/food.png">
  <!-- For Windows Phone -->
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/food.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
...
<table>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2023 <a class="grey-text text-lighten-4" href="#" target="_blank"></a> All rights reserved.</span>
        <span class="right"> Developed by David Sonkin <a class="grey-text text-lighten-4" href="#"></a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
